...
<section>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <a href="/film-create" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Add New Film</a>
        <table class="min-w-full mt-4 bg-white border border-gray-300">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-center">
                    <a href="/film-edit/<?= $film['id'] ?>" class="text-blue-500 hover:text-blue-700 mr-4">Edit</a>
                    <a href="/film-delete/<?= $film['id'] ?>" class="text-red-500 hover:text-red-700 mr-4">Delete</a>
